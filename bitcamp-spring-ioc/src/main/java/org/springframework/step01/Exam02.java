...
public class Exam02 {
    ...
    public static void main(String[] args) {
        ...
        //    소스 코드를 변경해야 하는 문제가 있기 때문에
        //    보통 ClassPathXmlApplicationContext를 사용한다.
        iocContainer = new FileSystemXmlApplicationContext(
                "C:\\Users\\doni\\git\\bitcamp\\bitcamp-spring-ioc\\src\\main\\java\\org\\springframework\\step01\\application-context.xml");
