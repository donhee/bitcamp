...
package org.springframework.step13.ex05;
...
public class MyAdvice {
    ...
    /*
        <aop:before 
            ...
            method="doBefore"/>
    */
    @Before("execution(* org.springframework.step13.ex05.X.*(..)) and args(a,b)")
     ...
     */
    @AfterReturning(
            pointcut="execution(* org.springframework.step13.ex05.X.*(..))",
            returning="returnValue")
