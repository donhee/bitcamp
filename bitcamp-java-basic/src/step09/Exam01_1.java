...
public class Exam01_1 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // s1과 s2는 다른 인스턴스이다.
        // => 증명
        if (s1 == s2) { // s1에 저장되어 있는 주소 값과 s2의 주소 값과 비교한다.
        ...
        //    그러면 JVM이 바이트 배열에 들어 있는 값을 유니코드로 제대로 바꿀 것이다.
