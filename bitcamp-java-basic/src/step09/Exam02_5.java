// 인스턴스 메서드 클래스 메서드의 활용 - Calendar 클래스 
package step09;
...
public class Exam02_5 {
    public static void main(String[] args) throws Exception{
        ...
        // 인스턴스 메서드 활용!
        System.out.println(c.get(1)); // 1은 년
        System.out.println(c.get(2) + 1); // 0~11 월
        System.out.println(c.get(5)); // 5는 일
        System.out.println(c.get(7)); // 7은 요일(1 ~ 7) 일 월 화 수 목 금 토
