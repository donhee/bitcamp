...
public class Exam05_3 {
    public static void main(String[] args) {
        ...
        // => 숫자 뒤에 L 또는 l 을 붙여라 !
        // => 보통 대문자를 붙인다. 왜? 소문자 l 은 숫자 1과 헷갈리기 때문이다.
        ...
        System.out.println(Integer.MIN_VALUE); // 4바이트로 표현할 수 있는 정수 최대값
        System.out.println(Long.MAX_VALUE); // 8바이트로 표현할 수 있는 정수 최대값
        System.out.println(Long.MIN_VALUE); // 8바이트로 표현할 수 있는 정수 최대값
...
// L 또는 l 이 없으면 컴퓨터는 4바이트 정수로 알아듣는다. 
// L 또는 l 이 붙으면 8바이트 정수이다.