...
public class Exam01_1 {
    public static void main(String[] args) throws Exception {
        ...
        //SqlSessionFactoryBuilder builder = new SqlSessionFactoryBuilder(); // => builder 패턴 적용
        ...
        // sqlSession 객체 만든것 까지 mybatis 준비 완료이다.
