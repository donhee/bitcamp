...
public class Exam04_1{
    public static void main(String[] args) {
        ...
        // 바깥 쪽에 별도 선언한 클래스 사용하기
        Score s1 = new Score();
        s1.name = "홍길동";
        System.out.println(s1.name);
    }
}
// javac -encoding UTF-8 -d bin src/step03/Exam04_1.java 로 컴파일하면 안되고
// 클래스 파일만 있을 경우에는 
// javac -encoding UTF-8 -d bin -cp bin src/step03/Exam04_1.java 사용하고,
// 소스 파일만 있을 경우에는
// javac -encoding UTF-8 -d bin -sourcepath src src/step03/Exam04_1.java 

// Exam04_1.java 컴파일 오류!
// - 다음 명령을 사용하여 소스 파일을 컴파일 하려하면
...
//   방법 1) Score.class 파일을 갖고 있다면 그 파일이 있는 위치를 알려줘라.
//   > javac -encoding UTF-8 -d bin -cp bin src/step03/Exam04_1.java
//   방법 2) Score 클래스의 소스 파일을 갖고 있다면 소스 파일의 위치를 알려줘라.
//   > javac -encoding UTF-8 -d bin -sourcepath src src/step03/Exam04_1.java
//
// 언제 이렇게 해야 하는가?
