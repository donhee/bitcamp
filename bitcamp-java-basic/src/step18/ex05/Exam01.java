    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Method m : methods) {
            ...
            for (Parameter p : parameters) {
                ...
                // 설정해준다면, 원래의 파라미터 이름을 알아낼 수 있다.
                // javac -encoding UTF-8 -d bin -parameters src/step18/ex05/Exam01.java
                // 즉 -parameters 옵션으로 추가하여 컴파일하면 Reflection API로 파라미터 이름을 꺼낼 수 있다.
                ...
                // Eclipse 에선
                // Window -> Preferences -> java -> Compiler -> Store information about method parameters 체크
            }
        }
    }
}
