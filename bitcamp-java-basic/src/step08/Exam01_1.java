...
public class Exam01_1 {
    ...
    public static void main(String[] args) {
        class A {
            ...
            boolean v2; // true, false 논리 값을 저장할 메모리를 만들라는 명령
            // 이 명령은 new 명령을 실행할 때 비로서 실행된다. --> 인스턴스 변수
        }
        ...
        A obj3 = new A();
        //
        // 이렇게 생성된 메모리를 "인스턴스" 또는 "객체"라고 부른다.
        // 이 인스턴스의 주소를 저장하는 obj1, obj2, obj3를 "레퍼런스"라 부른다.
        // 그래서 인스턴스가 생성될 때 만들어지는 v1, v2 변수를 "인스턴스 변수"라 부른다.
