...
public class Exam08_3 {
    public static void main(String[] args) {
        ...
        d = i; // int(4) ==> double(8)
               // double 의 가수부는 52비트 크기를 갖는다.
               // 따라서 int(32비트) 값을 그대로 저장할 수 있다.
        System.out.println(d);       

        l = 18_2345_3456_4567_5678L; // <<< 52비트가 넘어가는 정수이다.
        d = l; // long(8) ==> double(8)
...
// 결론!
// 정수 메모리의 값(byte, short, int, long)을
// 부동 소수점 메모리(float, double)에 저장할 때
// 주의해서 사용하라!!!!
// 큰 정수 값이 부동소수점 메모리에 저장될 때 값이 짤릴 수 있다.
// 컴파일 오류가 발생하지 않기 때문에 
// 개발자들이 놓치는 경우가 많다!!!  ******중요!!********