...
public class Exam03 {
    ...
    public void test() {
        // 같은 인스턴스 메서드 안에서는 인스턴스 중첩 클래스(non-static nested class; inner class)를 마음대로 사용할 수 있다.
    ...
    public static void main(String[] args) {
        ...
        // Inner 클래스도 Exam03의 인스턴스 멤버이기 때문에
        // Exam03의 인스턴스 주소가 있어야 사용할 수 있다.
        // 원리는 똑같다.
        
        // 인스턴스 멤버(변수,메서드,inner class) 사용법
        // 1) 먼저 인스턴스를 생성하라!
        ...
        // => 중첩 클래스의 객체를 만들 때는 바깥 클래스(Exam03)의 객체 주소를 넘겨줘야 하기 때문에
        //    인스턴스 생성할 때는 바깥 클래스의 객체 주소(obj)가 있어야 한다.
    }
}