...
public class Server3 {
    public static void main(String[] args) throws Exception {
        ...
        ServerSocket ss = new ServerSocket(8888, 2); // 대기열은 최대 2개
...
//      25(SMTP), 53(DNS), 80(HTTP), 110(POP3), 143(IMAP4) 등
// => 1024 ~ 49151 (registered port)
//    - 일반적인 통신 프로그램을 작성할 때 이 범위 포토 번호를 사용한다.
//    - 다만 이 범위에 번호 중에서 특정 프로그램이 널리 사용하는 번호가 있다.
//      가능한 그 번호도 피하라!
//    - 8080(proxy 서버 포트), 1521(Oracle), 3306(MySQL) 등 
