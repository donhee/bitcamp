...
public class DefaultApplicationContainer implements ApplicationContainer {
    ...
    public DefaultApplicationContainer() throws Exception {
        ...
        iocContainer = new AnnotationConfigApplicationContext(AppConfig.class);
                        ...
                        // => 내부적으로 지정된 패키지를 뒤지면서 그 클래스중에서 @Componet를 찾아서 객체를 생성한다.
    }
    ...
    public String execute(String requestURI) {
        ...
        StringWriter memoryWriter = new StringWriter(); // 메모리에 저장 // Data sink Stream
        PrintWriter out = new PrintWriter(memoryWriter); // Decorator
