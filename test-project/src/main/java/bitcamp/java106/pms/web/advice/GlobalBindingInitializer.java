...
// Team,Classroom,TaskController 에만 ControllerAdvice 애노테이션을 적용하는 제약 조건 : assignableTypes
@ControllerAdvice(assignableTypes= {TeamController.class, ClassroomController.class, TaskController.class}) // 특정 클래스에 대해서만 제약 조건을 걸 수도 있다.
