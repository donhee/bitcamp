...
public class CustomDateEditor extends PropertyEditorSupport {
    ...
    // 이 메서드는 스프링 IoC Container가 String 타입의 프로퍼티 값을
    // "다른 타입의 값"으로 바꿀 때 호출하는 메서드이다.
    @Override
    public void setAsText(String text) throws IllegalArgumentException {
        System.out.println("customDateEditor.setAsText() 호출됨!");
        // 파라미터로 넘어온 String 타입의 프로퍼티 값을
        // 원하는 타입(java.sql.Date)의 값으로 바꿔 내부에 저장하라!
        // => 그러면 스프링 IoC Container는 이 값을 꺼내서 객체에 주입할 것이다.
    ...
    public void setValue(Object value) {
        ...
        System.out.println("customDateEditor.setValue() 호출됨!");
    ...
    public Object getValue() {
        // 이 메서드는 단지 호출되었을 때 그것을 표시하기 위해 오버라이딩 했다.
        System.out.println("customDateEditor.getValue() 호출됨!");
