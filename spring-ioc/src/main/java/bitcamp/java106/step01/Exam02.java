...
public class Exam02 {
    ...
    public static void main(String[] args) {
        ...
        //    => FileSystem.XmlApplicationContext (OS 파일시스템에서 xml파일을 찾는다)
        // 2) 클래스 안에 애노테이션을 읽어서 처리하는 IoC 컨테이너
        //    => AnnotationConfigApplicationContext
        //
        
        
        // FileSystemXmlApplicationContext 사용
        // => OS 파일 시스템에서 지정된 경로의 파일을 찾는다.
        // => 파일시스템의 실제 경로를 지정하게 되면 나중에 그 경로가 바뀌면
        //    또 소스 코드를 변경해야 하는 번거로움이 있다.
        //    그래서 보통 ClassPathXmlApplicationContext를 많이 사용한다!!!
        iocContainer = new FileSystemXmlApplicationContext("file:\\C:\\Users\\doni\\git\\bitcamp\\spring-ioc\\src\\main\\java\\bitcamp\\java106\\step01\\application-context.xml");
