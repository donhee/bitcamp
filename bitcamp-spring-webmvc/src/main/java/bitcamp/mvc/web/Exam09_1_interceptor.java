...
// => 배치방법?
//    1) 자바 코드
//    2) XML 설정 : mvc-servlet.xml을 참고하라!
// => 인터셉터 사용 예)
//    - 사용자 인증 또는 권한 검사할 때
//    - 로그를 남길 때
...
public class Exam09_1_interceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
            throws Exception {
        System.out.println("Exam09_1_interceptor.preHandle() 호출됨!");
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
        ...
        System.out.println("Exam09_1_interceptor.postHandle() 호출됨!");
    }
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
        ...
        System.out.println("Exam09_1_interceptor.afterCompletion() 호출됨!");
    }
}
