...
public class Exam05_3 {
    ...
    // 테스트 방법: http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_3/m1?no=101&title=aaa&content=bbb
    ...
    // 테스트 방법: http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_3/m2?no=101&title=aaa&content=bbb&writer=hong
    ...
    // 테스트 방법: http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_3/m3?no=101&title=aaa&content=bbb&user.id=hong&user.email=2313do@test.com&user.password=1111
    // 객체 안에 있는 객체 프로퍼티 값 설정하기
    @GetMapping(value="m3")
    @ResponseBody 
    public String m3(Board board) {
        return String.format("m2(): %s", board);
    }
