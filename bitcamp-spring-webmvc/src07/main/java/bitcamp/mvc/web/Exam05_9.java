...
public class Exam05_9 {
    ...
    // @RequestBody를 사용한다.
    // 테스트 방법 : http://localhost:8888/bitcamp-spring-webmvc/exam05_9.html
    @PostMapping(value="post")
    @ResponseBody
                    // application/x-www-form-urlencoded 형식으로 넘어올 때는
    ...
    public String m5(@RequestBody String content) {
        ...
        Board board = gson.fromJson(content, Board.class);
                                             // 기본이 f
        return String.format("m5(): no=%d, title=%s, content=%s, createdDate=%s", 
