...
public class Exam05_4 {
    ...
    // 테스트 방법: http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_4/m1?title=aaa&content=bbb&createdDate=2018-06-04
    @GetMapping(value="m1")
    @ResponseBody 
    ...
    // 단 파라미터 앞에 @RequestParam을 반드시 붙여야 한다.
    // 테스트 방법 : http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_4/m2?member=hong,hong@test.com,1111
    @GetMapping(value="m2")
    @ResponseBody 
    ...
    // 각 페이지 컨트롤러에 '프로퍼티 에디터'를 등록할 수 있다.
    // 메서드의 형식은 : 
