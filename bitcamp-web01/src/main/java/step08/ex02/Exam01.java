...
public class Exam01 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!op.equals("+")) {
            // + 연산자가 아니라면 다음 서블릿(step08/ex2/exam02)에게 실행을 위임한다.
        ...
        //    서버에서는 "공백 문자"로 간주한다.
        // 예) http://localhost:8888/bitcamp-web01/step08/ex2/calculator?op=+&a=20&b=15
        // => 즉, URL에서 '+' 문자는 공백을 표시할 때 사용하는 특수 기호이다.
        // 따라서 다음과 같은 방법을 사용해야 한다.
        // => URL 파라미터 값으로 '+' 문자를 서버에 보내고 싶다면 URL 인코딩 값을 보내라!!!
        // => '+' ===> %2B (%2b)
        // => 예) http://localhost:8888/bitcamp-web01/step08/ex2/calculator?op=%2b&a=20&b=15
