...
public class Exam03 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //   버퍼에 차는 순간 즉시 자동으로 클라이언트로 버퍼의 내용물을 내보내기 때문에
        //   redirect를 할 수 없다.
        //   그것을 떠나서 redirect는 클라이언트에게 뭔가를 출력하지 않고
        //   다른 URL로 이동하라는 명령만 내릴 때 사용한다고 했다.
        //   그런데도 불구하고 redirect를 사용할거면서 출력하는 것은 뭔가요?
        //   출력하고 싶으면 refresh를 써야하는데
        //   redirect를 사용하기로 해놓고 출력하는 것은 뭔가요?
        //   그러니까 redirect를 사용하면서 버퍼가 찰 것을 걱정하지 말 것!
        ...
        Content-Length: 0
        Date: Fri, 18 May 2018 02:12:46 GMT
        // 내용물없음
        */ 
    }
