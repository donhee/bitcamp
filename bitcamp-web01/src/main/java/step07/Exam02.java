...
public class Exam02 extends HttpServlet {
    ...
    public Exam02() {
        System.out.println("step07.Exam02() 호출됨!");
    }
    
    @Override
    public void init() throws ServletException {
        System.out.println("step07.Exam02.init() 호출됨!");
    }
    
    // 다른 서블릿들을 위해 초기화 작업을 수행하는 서블릿인 경우
    // 굳이 service()나 doXxx() 메서드를 만들 필요가 없다.
    // 왜? 클라이언트에서 직접 실행할 서블릿이 아니기 때문이다.
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("step07.Exam02.service() 호출됨!");
