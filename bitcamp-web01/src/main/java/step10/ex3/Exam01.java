...
public class Exam01 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // - 만약 없다면 새 세션을 객체(HttpSession)를 생성한 후 그 세션 객체를 리턴한다.
        // - 응답할 때 새로 생성한 세션 객체의 아이디를 웹브라우저로 쿠키에 담아 전달한다.
        //
        // - HTTP 응답 프로토콜 예:
        //        HTTP/1.1 200
        //        Set-Cookie: JSESSIONID=BEBADE15EA6DE9BE33C99BA2CA3F88E4; Path=/bitcamp-web01; HttpOnly
        //        Content-Type: text/plain;charset=UTF-8
        //        Content-Length: 119
        //        Date: Wed, 23 May 2018 05:22:54 GMT
    }
    
    // 서블릿 컨테이너마다 다르다 
    // 톰캣 서버인 경우 --> JSESSIONID
