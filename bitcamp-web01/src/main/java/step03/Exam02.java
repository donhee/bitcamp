...
public class Exam02 extends GenericServlet {
    ...
    public void service(ServletRequest request, ServletResponse response) throws ServletException, IOException {
        ...
        response.setContentType("text/plain; charset=UTF-8");
                              // 서버가 브라우저(client)에게 "순수한 text를 보낼것이다. 그리고 UTF-8 로 사용할 것이다" 라고 지정한 것이다. 
        ...
        //response.setContentType("text/plain; charset=UTF-8"); ==> 출력스트림을 꺼내기 전에 지정해줘야한다.
        out.println("Hello"); // 바로 클라이언트로 out해서 보여주는 것이 아니라. 내부 버퍼에 저장되는 것이다
        
        // 문제는 한글이다.
        // 한글을 ISO-8859-1에 코드가 명시되어 있지 않다.
