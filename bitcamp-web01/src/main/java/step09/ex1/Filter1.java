...
// - 예)
//   => 클라이언트의 접속을 기록하는 기능 수행
//   => 클라이언트가 보낸 데이터의 압축을 해제시킨다.
//   => 클라이언트가 보낸 데이터의 암호를 해제시킨다.
...
public class Filter1 implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        // 당연히 필터가 작업할 때 사용할 도구를 준비시키는 코드를 여기에 둔다.
        this.config = filterConfig;
        System.out.println("Filter1.init() 호출됨!");
    }
    ...
    public void destroy() {
        ...
        System.out.println("Filter1.destroy() 호출됨!");
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) 
        ...
        // 서블릿이 클라이언트의 요청을 처리하는데 필요한 것들을 여기에서 준비한다.
