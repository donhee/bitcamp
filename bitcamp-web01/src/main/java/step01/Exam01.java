...
//      예) 톰캣 서버
// => 일반적으로 실행할 수 있는 자바 클래스를 만들듯이 main() 메서드를 만들어봐야 소용없다.
...
public class Exam01 implements Servlet {
    ...
    public Exam01() {
        System.out.println("Exam01() 생성자 호출됨!");
    }
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        System.out.println("Exam01.init() 호출됨!");
        this.config = config;
    }
    
    @Override
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        // 클라이언트가 이 서블릿의 실행을 요청할 때마다 호출된다. => 웹 브라우저에서 F5 누르면 다시 service() 호출됨!
        // => 서블릿이 해야할 일을 처리하는 코드를 여기에 둔다.
        System.out.println("Exam01.service() 호출됨!");
    }
    ...
    public void destroy() {
        ...
        System.out.println("Exam01.destroy() 호출됨!");
    }
