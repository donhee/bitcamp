...
<!-- http://m.zdnet.co.kr/news_view.asp?article_id=20180528085226 -->
<h2>HTTP 요청을 수행한 후 그 결과를 가져오기</h2>
<c:url value="http://m.zdnet.co.kr/news_view.asp" var="url1" scope="page">
...
<textarea cols="150" rows="45">${pageScope.result}</textarea>
