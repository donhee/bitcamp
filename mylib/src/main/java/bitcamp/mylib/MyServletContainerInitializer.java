// 라이르러리 개발자는 웹 애플리케이션이 시작할 때 
// 보고를 받고 싶다.
// 왜?  필요하다면 라이브러리를 사용하기 전에 초기화시키려고 한다.
// 방법
...
public class MyServletContainerInitializer implements ServletContainerInitializer {
    ...
    @Override
    public void onStartup(Set<Class<?>> messageInitializers, ServletContext ctx) throws ServletException {
        // 서블릿 컨테이너가 웹 애플리케이션을 시작할 때
        // 나의 라이브러리에 대해 이 메서드를 호출해줄 것이다.
        System.out.println("--------------------------------------------------");
        System.out.println("===> MyServletContainerInitializer.onStartup() 호출");
